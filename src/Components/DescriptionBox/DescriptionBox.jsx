  ...
  return (
    <div className='descriptionbox'>
      <div className="descriptionbox-navigator">
            <div className="box-nav-box">Description</div>
            <div className="box-nav-box-fade">Reviews (122)</div>
      </div>
      <div className="box-description">
            <p>FamilyShop is an online platform that facilitates the buying and selling of products or services over the internet.
                  ...
                  E-commerce websites have gained immense popularity 
